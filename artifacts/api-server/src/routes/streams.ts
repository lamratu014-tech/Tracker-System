...
// PATCH /streams/:id — admin only
router.patch("/streams/:id", requireAdmin, async (req, res): Promise<void> => {
...
// DELETE /streams/:id — admin only
router.delete("/streams/:id", requireAdmin, async (req, res): Promise<void> => {
